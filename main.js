...
(function () {
  ...
  let resources = { energy: 0, food: 0, tech: 0, funds: 150, labor: 0, water: 0, recycled: 0 };
  ...
  const ARCHETYPES = {
    ...
    uurban:      { v:[0.45,0.70,0.55], resPref:{funds:0.35, recycled:0.15, tech:0.2}, disp:"都市再生都市" },
  ...
  function initGame() {
    ...
    resources = { energy: 0, food: 0, tech: 0, funds: 150, labor: 0, water: 0, recycled: 0 };
