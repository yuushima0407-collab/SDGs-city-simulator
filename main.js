// ===========================
// SDGs都市経営ゲーム main.js 改良版（15都市対応＋ポイント表示）
// ===========================
(function(){
window.addEventListener("DOMContentLoaded",()=>{
  ...
  const cityTypeUI={
    eco:$("ctp-eco"),
    industry:$("ctp-industry"),
    social:$("ctp-social"),
    smart:$("ctp-smart"),
    science:$("ctp-science"),
    culture:$("ctp-culture"),
    tourism:$("ctp-tourism"),
    agriculture:$("ctp-agriculture"),
    industryHeavy:$("ctp-industryHeavy")
  };
  ...
  function applyTypePoints(points){
    if(!points)return;
    for(const k in points){ cityTypePoints[k]+=points[k]||0; }
  }
